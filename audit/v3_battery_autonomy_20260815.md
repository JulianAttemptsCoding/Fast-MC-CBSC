...
atomically only after remote/local hash agreement, corrected reconstruction
event accounting, structural pass, all four separate C2ST families, checkpoint
provenance, and `test_events_used: 0`. A failed transaction is never retried or
...
Controller SHA-256 is `55544d93...`; the presentation guard is `082f66fe...`.
